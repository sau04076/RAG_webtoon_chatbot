...
new_df['view_count_vector'] = new_df['view_count'].progress_apply(lambda x: get_embedding(x, model='text-embedding-ada-002'))
new_df['favorite_count_vector'] = new_df['favorite_count'].progress_apply(lambda x: get_embedding(x, model='text-embedding-ada-002'))
...
new_df['star_score_vector'] = new_df['star_score'].progress_apply(lambda x: get_embedding(x, model='text-embedding-ada-002'))
new_df['epi_cnt_vector'] = new_df['epi_cnt'].progress_apply(lambda x: get_embedding(x, model='text-embedding-ada-002'))
